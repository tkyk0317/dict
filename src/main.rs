 ...
 */
trait Translator {
    fn translate(&self) -> Result<String, String>;
}

/**
 * String implements Translator trait.
 */
impl Translator for String {
    /**
     * translate specified word from english to japanese.
     */
    fn translate(&self) -> Result<String, String> {
        Ok(DictAPI::search_translate(&DictAPI::search_id(&self)?)?)
    }
}
...
impl DictAPI {
     ...
     * seach word id.
     */
    fn search_id(word: &String) -> Result<String, String> {
        ...
        // parse item-id.
        DictAPI::parse(&b).ok_or("parse is error".to_string())
    }

    /**
     * process translate.
     */
    fn search_translate(word_id: &String) -> Result<String, String> {
